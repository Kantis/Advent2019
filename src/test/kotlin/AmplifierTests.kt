...
class AmplifierTests {
    ...
    @Test
    fun `given input 1`() {
        val result = optimizePhaseSettings(arrayOf(3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0))
        assertEquals(43210, result.first)
        assertEquals(listOf(4,3,2,1,0), result.second)
    }
